...
from agentsmithy.db import BaseORM, ToolResultORM
from agentsmithy.db.base import get_engine, get_session
...
from agentsmithy.tools.registry import (
...
class ToolResultsStorage:
    ...
    def _generate_summary(
        ...
        try:
            import agentsmithy.tools.builtin  # noqa: F401
        except Exception:
            pass
