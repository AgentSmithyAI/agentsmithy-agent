UNIVERSAL_SYSTEM = (
    ...
    "# Dialog Management\n"
    "- If the current dialog doesn't have a title yet (or it's 'default'), set a descriptive one using set_dialog_title tool.\n"
    "- The title should be concise (max 50 characters), clear, and reflect the main topic.\n"
    "- Don't set the title if it's already appropriate for the current discussion.\n"
    "# Rules\n"
